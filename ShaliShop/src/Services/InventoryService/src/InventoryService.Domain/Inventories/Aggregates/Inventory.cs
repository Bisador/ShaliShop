using InventoryService.Domain.Inventories.DomainEvents;
using InventoryService.Domain.Inventories.Exceptions;
using Shared.Domain;

namespace InventoryService.Domain.Inventories.Aggregates;
