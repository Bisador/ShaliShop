...
namespace CheckoutService.Persistence.Migrations.Checkout
{
    ...
    [Migration("20250731023901_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CheckoutService.Domain.Carts.Aggregates.Cart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CheckoutService.Domain.Carts.Aggregates.Cart", b =>
                {
                    b.OwnsMany("CheckoutService.Domain.Carts.ValueObjects.CartItem", "Items", b1 =>
                        {
                            ...
                            b1.OwnsOne("SharedService.Domain.ValueObjects.Money", "UnitPrice", b2 =>
                                {
